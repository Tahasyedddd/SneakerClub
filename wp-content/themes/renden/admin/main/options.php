...
function thinkup_customizer_theme_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_button_link(
			...
			array(
				'title'        => esc_html__( 'Need help?', 'renden' ),
				'priority'     => 1,
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade_inner(
			...
			array(
				...
				'price_discount'  => esc_html__( 'Upgrade Now (10% off)', 'renden' ),
				'price_normal'	  => esc_html__( 'Use coupon at checkout for 10% off.', 'renden' ),
				'coupon'	      => esc_html__( 'thinkup10', 'renden' ),
